...
options:
    ...
    port:
        description:
            - "The port field (minimum: 1) (maximum: 65535)"
        type: int
        required: false
    ...
    traffic_limit_bytes:
        description:
            - "The trafficLimitBytes field (minimum: 0)"
        type: int
        required: false
    notify_percent:
        description:
            - "The notifyPercent field (minimum: 0) (maximum: 100)"
        type: int
        required: false
    traffic_reset_day:
        description:
            - "The trafficResetDay field (minimum: 1) (maximum: 31)"
        type: int
        required: false
    country_code:
        description:
    ...
    consumption_multiplier:
        description:
            - "The consumptionMultiplier field (minimum: 0) (maximum: 100)"
        type: float
        required: false
    config_profile:
        description:
    ...
    provider_uuid:
        description:
            - "The providerUuid field (format: uuid)"
        type: str
        required: false
    tags:
        description:
